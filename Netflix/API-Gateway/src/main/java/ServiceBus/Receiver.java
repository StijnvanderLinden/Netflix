...
public class Receiver {
    ...
    public static void main(String[] args) throws Exception, ServiceBusException {
        ...
        SubscriptionClient subscription2Client = new SubscriptionClient(new ConnectionStringBuilder(connectionString, "topictest/subscriptions/S2"), ReceiveMode.PEEKLOCK);
        SubscriptionClient subscription3Client = new SubscriptionClient(new ConnectionStringBuilder(connectionString, "topictest/subscriptions/S3"), ReceiveMode.PEEKLOCK);
